...
do
    ...
    do
        ...
        do
            python train_PAES.py --test_prompt_id ${prompt} --attribute_name ${attribute} --seed ${seed}
        done
    done
    ...
    do
        python train_PAES.py --test_prompt_id 7 --attribute_name ${attribute} --seed ${seed}
    done

    for attribute in score content organization word_choice sentence_fluency conventions
    do
        python train_PAES.py --test_prompt_id 8 --attribute_name ${attribute} --seed ${seed}
    done
done